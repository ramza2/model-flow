...
SOURCE_MYSQL_HOST_PORT=13307
SOURCE_MARIADB_HOST_PORT=13308
SOURCE_MSSQL_HOST_PORT=11433
SOURCE_ORACLE_HOST_PORT=11521
...
export SOURCE_MYSQL_ROOT_PASSWORD="${SOURCE_MYSQL_ROOT_PASSWORD:-mysql_root_port_test_pw}"
export SOURCE_MYSQL_USER="${SOURCE_MYSQL_USER:-mysql_port_test}"
export SOURCE_MYSQL_PASSWORD="${SOURCE_MYSQL_PASSWORD:-mysql_port_test_password}"
export SOURCE_MYSQL_DB="${SOURCE_MYSQL_DB:-mysql_port_test}"
export SOURCE_MARIADB_ROOT_PASSWORD="${SOURCE_MARIADB_ROOT_PASSWORD:-maria_root_port_test_pw}"
export SOURCE_MARIADB_USER="${SOURCE_MARIADB_USER:-maria_port_test}"
export SOURCE_MARIADB_PASSWORD="${SOURCE_MARIADB_PASSWORD:-maria_port_test_password}"
export SOURCE_MARIADB_DB="${SOURCE_MARIADB_DB:-maria_port_test}"
export SOURCE_MSSQL_SA_PASSWORD="${SOURCE_MSSQL_SA_PASSWORD:-Ms1.source_port_test_sa}"
export SOURCE_MSSQL_USER="${SOURCE_MSSQL_USER:-mssql_port_test}"
export SOURCE_MSSQL_PASSWORD="${SOURCE_MSSQL_PASSWORD:-Ms1.source_port_test_pw}"
export SOURCE_MSSQL_DB="${SOURCE_MSSQL_DB:-mssql_port_test}"
export SOURCE_ORACLE_SYSTEM_PASSWORD="${SOURCE_ORACLE_SYSTEM_PASSWORD:-Or1.source_port_test_sys}"
export SOURCE_ORACLE_APP_USER="${SOURCE_ORACLE_APP_USER:-oraapp_port_test}"
export SOURCE_ORACLE_APP_PASSWORD="${SOURCE_ORACLE_APP_PASSWORD:-Or1.source_port_test_app}"
export SOURCE_ORACLE_USER="${SOURCE_ORACLE_USER:-oraro_port_test}"
export SOURCE_ORACLE_PASSWORD="${SOURCE_ORACLE_PASSWORD:-Or1.source_port_test_ro}"
export SOURCE_ORACLE_SERVICE_NAME="${SOURCE_ORACLE_SERVICE_NAME:-FREEPDB1}"
...
export SOURCE_MYSQL_HOST_PORT SOURCE_MARIADB_HOST_PORT SOURCE_MSSQL_HOST_PORT
export SOURCE_ORACLE_HOST_PORT
...
if ! docker run --rm \
  ...
  -e SOURCE_MYSQL_HOST_PORT \
  -e SOURCE_MARIADB_HOST_PORT \
  -e SOURCE_MSSQL_HOST_PORT \
  -e SOURCE_ORACLE_HOST_PORT \
