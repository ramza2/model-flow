...
**Current tip:** `3f466f4`  
**GitHub Actions:** https://github.com/ramza2/model-flow/actions/runs/30620181580 — **success**  
...
| AC-27 | PR targeting `main` runs full verification gate | PASS | PR Check on #4 | Actions run `30620181580` | success on tip `3f466f4` |
...
| AC-72 | GitHub Actions Full gate PASS on Draft PR | PASS | Tip workflow success | Actions on `cursor/modelflow-v1-rc-71f2` | run `30620181580` |
...
None for AC-01…AC-72 on tip `3f466f4` (local clean gate PASS; GitHub Actions run `30620181580` success).
