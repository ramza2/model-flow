...
| Debt | Resolution |
| --- | --- |
| Autonomous SELECT / UDF | Package-qualified and non-allowlisted bare calls rejected; COUNT/SUM/AVG/NVL/COALESCE/CAST/TO_CHAR/… allowed. Fixture seeds `side_effect_probe` (autonomous INSERT); live test proves RO bypass + validator block. |
