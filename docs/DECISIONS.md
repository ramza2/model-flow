...
- **Consequences:** Graph `schema_version` stays `1` with no DB migration. Group By outputs remain ordinary Preparation-produced Parquet DatasetVersions; TrainingJob does not special-case Group By. Pivot / Unpivot stay Phase 2-F.
